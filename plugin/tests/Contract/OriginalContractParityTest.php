 ...
 * all (13 of our 64 — the ping scaffolding, `get_board`, `pin_task`/`unpin_task`,
...
final class OriginalContractParityTest extends TestCase
{
     ...
     *
     * 143 tools live on the original; 51 of them exist here; 92 do not.
     ...
     * (96 -> 95). D5a Task 10 ported get_task_connections/get_flow_order/
     * recompute_flow_steps (95 -> 92) — recomputed from this test's own run
     * rather than by arithmetic: it reported "expected 95, got 92" before this
     * constant moved.
     */
    private const EXPECTED_UNPORTED_COUNT = 92;

    /**
     * The original's full live surface: 143 snapshotted, all with real
     * schemas, and `liveOnlyToolNames` now EMPTY. (This said "131 snapshotted
     * + 12 known live-only names" until D5a Task 8 corrected it — the
     * 131+12 split was retired when the snapshot was re-synced in 5e2289f,
     * which captured real shapes for all 143. The total it guards was right
     * either way, which is exactly why the stale split survived.)
     */
